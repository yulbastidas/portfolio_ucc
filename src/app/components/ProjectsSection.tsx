...
const projectsData: ProjectWithGithub[] = [
  {
    ...
    description:
      'Esta plataforma es para que principalmente los niños aprendan jugando, viendo videos , de una manera mas entretenida , fortaleciendo su mente',
  ...
  },
  {
    ...
    description:
      'Es como una plataforma de pinterest donde puedes buscar tus intereses',
